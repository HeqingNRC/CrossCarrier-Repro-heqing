...
TASK_DIR = Path(os.environ.get("V921_TASK_ROOT", str(ROOT / "tasks" / _TASK_DIR_NAME)))
MANIFEST_DIR = TASK_DIR / "manifest"
DATASET_ROOT = Path(os.environ.get("V921_DATASET_ROOT", str(ROOT)))
...
TRAIN_FREQS = os.environ.get("V921_TRAIN_FREQS", "10GHz,24GHz").split(",")
TEST_FREQS = os.environ.get("V921_TEST_FREQS", "77GHz").split(",")
...
SEED = 42
AMP_DTYPE = os.environ.get("V921_AMP_DTYPE", "bf16")
...
SEEDED_HFT = os.environ.get("V921_SEEDED_HFT", "0") == "1"
HFT_P = 0.65
HFT_FLOOR_AMP = 0.05
HFT_HF_AMP = 0.08
