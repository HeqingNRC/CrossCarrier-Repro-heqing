...
HAS_DATA = all((ROOT / task / 'manifest/train.csv').is_file() for task in (
    'tasks/cross_frequency_grouped/target10', 'tasks/cross_frequency_grouped/target24',
    'tasks/cross_frequency_grouped/target77', 'tasks/cross_frequency/target77'))
...
class CrossFrequencyTests(unittest.TestCase):
    ...
    @unittest.skipUnless(HAS_DATA, 'Requires private assets and prepare_cross_frequency.py --protocol both')
